...
> ⚠️ **DOCUMENTO HISTÓRICO — punto de partida, NO estado actual.** Este es el snapshot
> del **estado inicial** (contra v0.74.0) que arrancó el trabajo de paridad. Los
> blockers/majors/minors listados abajo **ya están cerrados** salvo lo anotado en el
> estado vigente. Para saber *qué falta hoy* mirá
> [`GO-REWRITE-STATUS.md`](GO-REWRITE-STATUS.md); la historia de los fixes está en `git log`.
