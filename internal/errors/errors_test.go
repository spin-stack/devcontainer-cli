...
func TestToErrorOutput_ContainerError(t *testing.T) {
	e := &ContainerError{
...
func TestToErrorOutput_GenericError(t *testing.T) {
...
func TestToErrorOutput_OmitsEmptyFields(t *testing.T) {
	e := &ContainerError{Description: "simple error"}
	out := ToErrorOutput(e)
	data, _ := json.Marshal(out)
	var m map[string]any
	json.Unmarshal(data, &m)
